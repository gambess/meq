...
function accesspresslite_bxslidercb(){
	...
	if((isset($accesspresslite_settings['slider1']) && !empty($accesspresslite_settings['slider1'])) 
		...
		|| (isset($accesspresslite_settings['slider6']) && !empty($accesspresslite_settings['slider6'])) 
    ...
    <?php 
        ...
        if($accesspresslite_settings['slider_options'] == 'single_post_slider'){
        	if(!empty($accesspresslite_settings['slider1']) 
                || !empty($accesspresslite_settings['slider2']) 
                || !empty($accesspresslite_settings['slider3']) 
                || !empty($accesspresslite_settings['slider4']) 
                || !empty($accesspresslite_settings['slider5']) 
                || !empty($accesspresslite_settings['slider6'])){
        		$sliders = array($accesspresslite_settings['slider1'],$accesspresslite_settings['slider2'],$accesspresslite_settings['slider3'], $accesspresslite_settings['slider4'], $accesspresslite_settings['slider5'], $accesspresslite_settings['slider6']);
				$remove = array(0);
